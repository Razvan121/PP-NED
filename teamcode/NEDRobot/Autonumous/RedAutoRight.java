       ...
       Drop1 = drive.trajectorySequenceBuilder(Pick1.end())
              ...
              /* .lineToConstantHeading(new Vector2d(51.9,4.4),
               ...
               .turn(toRadians(-60))
                3.8
               */
               .splineTo(new Vector2d(56.3,3.6),toRadians(47.2),
       ...
       // camera.stopStreaming();
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new WaitCommand(1900).andThen(new InstantCommand(() ->update(1640))).alongWith(new WaitCommand( 1950)).andThen(new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.DEPOSIT)))
                        ),
                        new WaitCommand(300),
                        ...
                        new ParallelCommandGroup(
                                ...
                                new WaitCommand(1300).andThen(new InstantCommand(() ->update(1640))).alongWith(new WaitCommand( 2400)).andThen(new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.DEPOSIT)))
                        ),
                        new WaitCommand(450),
                        new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.ClawState.OPEN)),
                        new WaitCommand(150),//350
