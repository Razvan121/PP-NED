...
@Config
@Disabled
@Autonomous(name = "RedAutoLeft3323", group="RED")
public class BlueAutoRight extends LinearOpMode {
    ...
    public void runOpMode() throws RuntimeException{
        ...
        intakeSubsystem.update(IntakeSubsystem.FourbarState.TRANSITION_DEPOSIT);
        ...
        Pick1 = drive.trajectorySequenceBuilder(Preload_drop.end())
                .setReversed(true)
                .splineTo(new Vector2d(55,-28),toRadians(270),
        ...
        Drop1 = drive.trajectorySequenceBuilder(Pick1.end())
                .setReversed(false)
                /*.splineTo(new Vector2d(50,-8),toRadians(90),
                        drive.getVelocityConstraint(30, toRadians(100),DriveConstants.TRACK_WIDTH),
                        drive.getAccelerationConstraint(30))
                .splineTo(new Vector2d(51.5,5.5),toRadians(30),
                        drive.getVelocityConstraint(25, toRadians(120),DriveConstants.TRACK_WIDTH),
                        drive.getAccelerationConstraint(25))

                 */
                /* .lineToConstantHeading(new Vector2d(51.9,4.4),
                         drive.getVelocityConstraint(40,toRadians(140), DriveConstants.TRACK_WIDTH),
                         drive.getAccelerationConstraint(40))
                 .turn(toRadians(-60))
                  3.8
                 */
                .splineTo(new Vector2d(56.3,3.6),toRadians(56),
                        drive.getVelocityConstraint(30,toRadians(120), DriveConstants.TRACK_WIDTH),
                        drive.getAccelerationConstraint(30))
        ...
        Pick2 = drive.trajectorySequenceBuilder(Drop1.end())
                .setReversed(true)
                .splineTo(new Vector2d(54,-28),toRadians(270),
                        drive.getVelocityConstraint(30, toRadians(140),DriveConstants.TRACK_WIDTH),
                        drive.getAccelerationConstraint(30))
                .build();
        ...
        Park1 = drive.trajectorySequenceBuilder(Drop3.end())
                .setReversed(false)
                .build();

        Park2 = drive.trajectorySequenceBuilder(Drop3.end())
                .setReversed(false)
                .turn(toRadians(30))
        ...
        Park3 = drive.trajectorySequenceBuilder(Drop3.end())
                .setReversed(false)
                .splineTo(new Vector2d(51,-23),toRadians(270),
                        drive.getVelocityConstraint(30,DriveConstants.MAX_ANG_VEL,DriveConstants.TRACK_WIDTH),
                        drive.getAccelerationConstraint(30))
                .build();
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        new ParallelCommandGroup(
                                ...
                                new WaitCommand(1900).andThen(new InstantCommand(() ->update(1800))).alongWith(new WaitCommand( 1950)).andThen(new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.DEPOSIT)))
                        ),
                        new WaitCommand(300),
                        new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.ClawState.OPEN)),
                        new WaitCommand(150),//350
                        ...
                        new WaitCommand(250),//500

                        new ParallelCommandGroup(

                                new InstantCommand(() ->update(0)),
                                new WaitCommand(300).andThen(new FollowTrajectoryCommand(drive,Pick1)),
                                new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.TRANSITION_DEPOSIT)),
                                new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.ClawState.OPEN))
                        ),
                        new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.INTAKE)),
                        new WaitCommand(350),
                        new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.ClawState.CLOSE)),
                        new WaitCommand(200),
                        new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.TRANSITION_DEPOSIT)),
                        ...
                        new ParallelCommandGroup(
                                ...
                                new WaitCommand(1300).andThen(new InstantCommand(() ->update(1690))).alongWith(new WaitCommand( 2400)).andThen(new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.DEPOSIT)))
                        ),
                        new WaitCommand(450),
                        new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.ClawState.OPEN)),
                        new WaitCommand(150),//350
                        ...
                        new ParallelCommandGroup(
                                ...
                                new InstantCommand(() ->update(0)),
                                new WaitCommand(300).andThen(new FollowTrajectoryCommand(drive,Pick3)),
                                new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.TRANSITION_DEPOSIT)),
                                new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.ClawState.OPEN))
                        ),
                        new InstantCommand(()->intakeSubsystem.update(IntakeSubsystem.FourbarState.INTAKE)),
